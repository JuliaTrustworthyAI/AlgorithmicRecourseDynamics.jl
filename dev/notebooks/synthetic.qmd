...
# Generators:
generators = (
    Bayesian=GreedyGenerator(loss=:logitbinarycrossentropy), 
    Plugin=GenericGenerator(loss=:logitbinarycrossentropy,ϵ=0.01)
)
```
...
μ = [0.05,0.1,0.25]
γ = [0.50,0.75,0.9]
grid_ = Experiments.GridVariables(models, generators, μ, γ)
n_rounds = 5
n_folds = 1
target = 1.0
T = 1000
