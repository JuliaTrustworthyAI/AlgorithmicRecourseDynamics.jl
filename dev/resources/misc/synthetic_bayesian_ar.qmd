...
𝑴 = BayesianLogisticModel(reshape(model.μ,1,length(model.μ)), model.Σ); # repare for usage with CounterfactualExplanations.jl
x̅ = [50.0, 60.0]; # factual
using Random
Random.seed!(1234)
y̅ = round(CounterfactualExplanations.Models.probs(𝑴, x̅)[1])
