...
```{r syn, fig.cap="Results for synthetic data with overlapping classes. The shown model MMD (PP MMD) was computed over a meshgrid of 1,000 points. Error bars indicate the standard deviation across folds."}
...
Zooming in on individual features we ...

```{r real, fig.cap="Results for deep ensemble using real-world datasets. The shown model MMD (PP MMD) was computed over a meshgrid of 10,000 points. Error bars indicate the standard deviation across folds."}
