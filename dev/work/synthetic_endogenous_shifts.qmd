...
using CounterfactualExplanations, CSV, DataFrames, LinearAlgebra, Distributions, Images, FileIO, Plots, PlotThemes
...
𝑴 = Models.FittedEnsemble(ensemble, opt, loss_type)
